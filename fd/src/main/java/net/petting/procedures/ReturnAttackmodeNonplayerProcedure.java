...
public class ReturnAttackmodeNonplayerProcedure {
	public static boolean execute(LevelAccessor world, Entity entity) {
		...
		return ("nonplayer").equals(entityFromStringUUID(entity.getData(PettingModVariables.PLAYER_VARIABLES).petsettingsuuid, (Level) world).getPersistentData().getString("attackmode"));
	}
