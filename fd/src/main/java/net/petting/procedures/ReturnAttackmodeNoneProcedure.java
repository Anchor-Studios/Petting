...
public class ReturnAttackmodeNoneProcedure {
	public static boolean execute(LevelAccessor world, Entity entity) {
		...
		return ("none").equals(entityFromStringUUID(entity.getData(PettingModVariables.PLAYER_VARIABLES).petsettingsuuid, (Level) world).getPersistentData().getString("attackmode"));
	}
