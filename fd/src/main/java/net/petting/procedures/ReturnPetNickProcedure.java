...
public class ReturnPetNickProcedure {
	public static String execute(LevelAccessor world, Entity entity) {
		...
		return entityFromStringUUID(entity.getData(PettingModVariables.PLAYER_VARIABLES).petsettingsuuid, (Level) world).getDisplayName().getString();
	}
